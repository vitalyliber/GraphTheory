  ...
  describe ".create_vertex" do
    ...
    context "edges tests" do
      it "should add new edges" do
        ...
        expect(graph_theory.create_edge 'first edge', 1, 2).to eq([
                                                                      {:name=>"first vertex", :value=>1, :edges=>[2]},
                                                                      {:name=>"second vertex", :value=>2, :edges=>[]},
                                                                      {:name=>"third vertex", :value=>3, :edges=>[]}
                                                                  ])
        expect(graph_theory.create_edge 'second vertex', 2, 3).to eq(
                                                                      [
                                                                          {:name=>"first vertex", :value=>1, :edges=>[2]},
                                                                          {:name=>"second vertex", :value=>2, :edges=>[3]},
                                                                          {:name=>"third vertex", :value=>3, :edges=>[]}
                                                                      ])
      end
      ...
      it "shouldn't have the same value as vertex" do
        ...
        expect((graph_theory.create_edge 'first edge', 1, 2).first).to eq({:name=>"first vertex", :value=>1, :edges=>[2]})
      ...
      it "shouldn't have more than two edges" do
        ...
        expect((graph_theory.create_edge 'second edge', 1, 3).first).to eq({:name=>"first vertex", :value=>1, :edges=>[2, 3]})
      ...
      it "shouldn't have a cycle" do
        ...
        expect((graph_theory.create_edge 'second edge', 2, 3)[1]).to eq({:name=>"second vertex", :value=>2, :edges=>[3]})

        expect(graph_theory.create_edge 'third edge', 3, 1).to eq({:status=>401, :message=>"Validator has find a cycle. Please choose an other vertexes"})
      end
